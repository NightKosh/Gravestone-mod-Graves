...
public class GSReciepes {
    ...
    public static void registration() {
        ...
        GameRegistry.addRecipe(getStackWithNTB(GSBlock.graveStone, (byte) EnumGraves.STONE_HORISONTAL_PLATE.ordinal(), "GraveType"), "c", "s", 's', Blocks.stone, 'c', GSItem.chisel);
        // pet graves
        ...
        GameRegistry.addRecipe(getStackWithNTB(GSBlock.graveStone, (byte) EnumGraves.STONE_CAT_STATUE.ordinal(), "GraveType"), " c", "  ", " s", 's', Blocks.stone, 'c', GSItem.chisel);
        // sword graves
