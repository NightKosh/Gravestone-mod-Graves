...
public class GraveStoneEntity {
    ...
    public void getEntity() {
        ...
        EntityRegistry.registerModEntity(EntityZombieCat.class, "GSZombieCat", 1, this, 40, 1, true);
        ...
        LanguageRegistry.instance().addStringLocalization("entity.GraveStone.mod_GraveStone.name", "GSZombieCat");
