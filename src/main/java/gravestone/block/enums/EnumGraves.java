...
public enum EnumGraves implements IBlockEnum {
    ...
    // OBELISKS
    WOODEN_OBELISK("block.gravestone.obelisk", Resources.GRAVE_WOODEN_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.WOOD),
    SANDSTONE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_SANDSTONE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.SANDSTONE),
    RED_SANDSTONE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_RED_SANDSTONE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.RED_SANDSTONE),
    STONE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_STONE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.STONE),
    DIORITE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_DIORITE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.DIORITE),
    ANDESITE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_ANDESITE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.ANDESITE),
    GRANITE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_GRANITE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.GRANITE),
    IRON_OBELISK("block.gravestone.obelisk", Resources.GRAVE_IRON_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.IRON),
    GOLDEN_OBELISK("block.gravestone.obelisk", Resources.GRAVE_GOLDEN_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.GOLD),
    DIAMOND_OBELISK("block.gravestone.obelisk", Resources.GRAVE_DIAMOND_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.DIAMOND),
    EMERALD_OBELISK("block.gravestone.obelisk", Resources.GRAVE_EMERALD_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.EMERALD),
    LAPIS_OBELISK("block.gravestone.obelisk", Resources.GRAVE_LAPIS_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.LAPIS),
    REDSTONE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_REDSTONE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.REDSTONE),
    OBSIDIAN_OBELISK("block.gravestone.obelisk", Resources.GRAVE_OBSIDIAN_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.OBSIDIAN),
    QUARTZ_OBELISK("block.gravestone.obelisk", Resources.GRAVE_QUARTZ_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.QUARTZ),
    PRIZMARINE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_PRIZMARINE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.PRIZMARINE),
    ICE_OBELISK("block.gravestone.obelisk", Resources.GRAVE_ICE_OBELISK, EnumGraveType.OBELISK, EnumGraveMaterial.ICE),
    // HORISONTAL PLATES
