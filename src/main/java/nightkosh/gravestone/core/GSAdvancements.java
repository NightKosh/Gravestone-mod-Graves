 ...
 */
public class GSAdvancements {

    public static final Identifier TOMB_RAIDER = fromNamespaceAndPath(ModInfo.ID, "tomb_raider");
    public static final Identifier FAITHFUL_TO_THE_END = fromNamespaceAndPath(ModInfo.ID, "faithful_to_the_end");
