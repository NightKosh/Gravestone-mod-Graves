...
public abstract class GravesDefaultText {
    ...
    public static final String[] NAMES = {
        ...
        "Kate", "Keeley", "Katherine", "Kaylee", "Kaidan", "Khloe", "Karen", "Kyra", "Kevin", "Kayleigh", "Kairo", "Kaleb", "Krystal",
        "Leslie", "Lex", "Lucy", "Liam", "Layla", "Luke", "Leo", "Leah", "Lilith", "Lawrence", "Leila", "Lexi", "Lacey", "Logan",
        "Mabel", "Madeline", "Marcus", "Max", "Mason", "Michael", "Mia", "Matthew", "Morty", "Marie", "Mary", "Marissa", "Miranda", "May",
