...
import static GraveStone.structures.catacombs.components.CatacombsBaseComponent.getCemeteryCatacombsStones;
...
public class StatuesHall extends CatacombsBaseComponent {
    ...
    public StatuesHall(int direction, Random random, int x, int y, int z) {
        super(direction);
        xShift = 3;
