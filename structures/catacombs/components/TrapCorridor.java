...
//
//        // blocks
//        this.func_175811_a(world, Blocks.stonebrick, 0, 0, 1, 2, boundingBox);
//        this.func_175811_a(world, Blocks.stonebrick, 0, 6, 1, 2, boundingBox);
//
//        // tripWire hook
//        this.func_175811_a(world, Blocks.tripwire_hook, getRightItemDirection(coordBaseMode), 1, 1, 2, boundingBox);
//        this.func_175811_a(world, Blocks.tripwire_hook, getLeftItemDirection(coordBaseMode), 5, 1, 2, boundingBox);
//
//        // tripWire
...
//        this.func_175811_a(world, Blocks.air, 0, 1, 2, 2, boundingBox);
//        this.func_175811_a(world, Blocks.air, 0, 5, 2, 2, boundingBox);
//
//        // web
