...
import static GraveStone.structures.ComponentGSCemeteryCatacombs.getCemeteryCatacombsStones;
...
public  class ComponentGSCemeteryCatacombsCreeper extends ComponentGSCemeteryCatacombs {
    ...
    private static final int[] valueableBlocks = {
    ...
    private void buildTopPart(World world, Random random, int yStart) {
        ...
        // spawner
        generateSpawner(world, 5, yStart, 5, "Creeper");
        ...
        // valueable block
        int valueableBlock = valueableBlocks[random.nextInt(valueableBlocks.length)];
        ...
        // creeper statue
        this.placeMemorial(world, random, 5, yStart + 1, 5, BlockGSMemorial.getMetaDirection(coordBaseMode), BlockGSMemorial.getMemorialType(random, 4));
